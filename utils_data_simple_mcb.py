...
class ChartFCDataset(Dataset):
    ...
    def __getitem__(self, index):
        txt, txt_len = encode_txt(self.dataset[index]['question'], self.txt2idx, self.maxlen)
        ...
        # ocr_text_vec, ocr_text_len = encode_txt(ocr_text, self.txt2idx, self.maxlen)

        return txt, label, img_tensor, idx, txt_len
