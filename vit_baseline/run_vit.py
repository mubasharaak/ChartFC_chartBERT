...
EXPT_DIR = os.path.join(args.data_root, 'experiments', "vit_baseline")
...
def main():
    ...
    shutil.copy(f'/scratch/users/k20116188/prefil/configs/config_vit.py',
                os.path.join(EXPT_DIR, 'config_vit.py'))
